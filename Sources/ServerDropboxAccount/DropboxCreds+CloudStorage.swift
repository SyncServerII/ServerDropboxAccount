...
extension DropboxCreds : CloudStorage {
    ...
    public func uploadFile(cloudFileName:String, data:Data, options:CloudStorageFileNameOptions? = nil, completion:@escaping (Result<String>)->()) {
    ...
    public func downloadFile(cloudFileName:String, options:CloudStorageFileNameOptions? = nil, completion:@escaping (DownloadResult)->()) {
    ...
    public func deleteFile(cloudFileName:String, options:CloudStorageFileNameOptions? = nil,
    ...
    public func lookupFile(cloudFileName:String, options:CloudStorageFileNameOptions? = nil,
